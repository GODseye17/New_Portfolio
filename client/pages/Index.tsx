    ...
    <div className="min-h-screen bg-dev-bg text-dev-white font-fira-code">
      ...
      <div className="fixed left-4 top-0 h-full flex flex-col items-center justify-center gap-2 z-10">
        ...
        <div className="flex flex-col gap-2">
          {/* GitHub */}
          <svg className="w-8 h-8 text-dev-gray hover:text-dev-white transition-colors cursor-pointer" viewBox="0 0 32 32" fill="currentColor">
      ...
      <div className="max-w-[1366px] mx-auto px-4 lg:px-[171px]">
        ...
        <header className="flex justify-between items-end py-8 mb-16">
          <div className="flex items-center gap-2">
            <Logo />
            <span className="text-dev-white font-fira-code text-base font-bold">Elias</span>
          </div>
          
          <nav className="flex items-start gap-8">
            <div className="flex items-start">
              <span className="text-dev-primary font-fira-code text-base font-medium">#</span>
              <span className="text-dev-white font-fira-code text-base font-medium">home</span>
            </div>
            <div className="flex items-start">
              <span className="text-dev-primary font-fira-code text-base font-normal">#</span>
              <span className="text-dev-gray font-fira-code text-base font-normal">works</span>
            </div>
            <div className="flex items-start">
              <span className="text-dev-primary font-fira-code text-base font-normal">#</span>
              <span className="text-dev-gray font-fira-code text-base font-normal">about-me</span>
            </div>
            <div className="flex items-start">
              <span className="text-dev-primary font-fira-code text-base font-normal">#</span>
              <span className="text-dev-gray font-fira-code text-base font-normal">contacts</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-dev-gray font-fira-code text-base font-bold">EN</span>
        ...
        <section className="flex flex-col lg:flex-row justify-between items-start mb-20 min-h-[423px]">
          <div className="max-w-[537px] pt-[74px]">
            <h1 className="text-dev-white font-fira-code text-[32px] font-bold leading-normal mb-8">
              Elias is a <span className="text-dev-primary">web designer</span> and{' '}
              <span className="text-dev-primary">front-end developer</span>
            </h1>
          ...
          <div className="relative">
            ...
            />
            <DotsPattern className="absolute bottom-0 right-0" rows={5} cols={5} />
            ...
            <div className="absolute bottom-0 left-16 flex items-center gap-2 p-2 border border-dev-gray bg-dev-bg">
              ...
              <span className="text-dev-gray font-fira-code text-base font-normal">
                Currently working on <span className="text-dev-white font-bold">Portfolio</span>
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="flex justify-center mb-24">
          <div className="relative max-w-[712px] border border-dev-gray bg-dev-bg p-8">
            ...
            <div className="absolute -bottom-6 right-4 border border-dev-gray bg-dev-bg p-4">
              <span className="text-dev-white font-fira-code text-2xl font-normal">- Dr. Who</span>
            </div>
        ...
        <section className="mb-24">
          <div className="flex justify-between items-center mb-12">
            ...
            <span className="text-dev-white font-fira-code text-base font-medium">View all ~~&gt;</span>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
              <div className="border border-dev-gray p-2">
                <div className="px-2 mb-2">
                  <h3 className="text-dev-white font-fira-code text-base font-bold">Languages</h3>
                </div>
                <div className="w-full h-px bg-dev-gray mb-2" />
                <div className="px-2 space-y-2">
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">TypeScript</span>
                    <span className="text-dev-gray font-fira-code text-base">Lua</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">Python</span>
                    <span className="text-dev-gray font-fira-code text-base">JavaScript</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-dev-gray p-2">
                <div className="px-2 mb-2">
                  <h3 className="text-dev-white font-fira-code text-base font-bold">Databases</h3>
                </div>
                <div className="w-full h-px bg-dev-gray mb-2" />
                <div className="px-2 space-y-2">
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">SQLite</span>
                    <span className="text-dev-gray font-fira-code text-base">PostgreSQL</span>
                  </div>
                  <div>
                    <span className="text-dev-gray font-fira-code text-base">Mongo</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-dev-gray p-2">
                <div className="px-2 mb-2">
                  <h3 className="text-dev-white font-fira-code text-base font-bold">Other</h3>
                </div>
                <div className="w-full h-px bg-dev-gray mb-2" />
                <div className="px-2 space-y-2">
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">HTML</span>
                    <span className="text-dev-gray font-fira-code text-base">CSS</span>
                    <span className="text-dev-gray font-fira-code text-base">EJS</span>
                    <span className="text-dev-gray font-fira-code text-base">SCSS</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">REST</span>
                    <span className="text-dev-gray font-fira-code text-base">Jinja</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-dev-gray p-2">
                <div className="px-2 mb-2">
                  <h3 className="text-dev-white font-fira-code text-base font-bold">Tools</h3>
                </div>
                <div className="w-full h-px bg-dev-gray mb-2" />
                <div className="px-2 space-y-2">
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">VSCode</span>
                    <span className="text-dev-gray font-fira-code text-base">Neovim</span>
                    <span className="text-dev-gray font-fira-code text-base">Linux</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">Figma</span>
                    <span className="text-dev-gray font-fira-code text-base">XFCE</span>
                    <span className="text-dev-gray font-fira-code text-base">Arch</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">Git</span>
                    <span className="text-dev-gray font-fira-code text-base">Font Awesome</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-dev-gray p-2">
                <div className="px-2 mb-2">
                  <h3 className="text-dev-white font-fira-code text-base font-bold">Frameworks</h3>
                </div>
                <div className="w-full h-px bg-dev-gray mb-2" />
                <div className="px-2 space-y-2">
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">React</span>
                    <span className="text-dev-gray font-fira-code text-base">Vue</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">Disnake</span>
                    <span className="text-dev-gray font-fira-code text-base">Discord.js</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-dev-gray font-fira-code text-base">Flask</span>
                    <span className="text-dev-gray font-fira-code text-base">Express.js</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mb-24">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
            ...
            <div className="border border-dev-gray p-4 min-w-[204px]">
              <h3 className="text-dev-white font-fira-code text-base font-bold mb-4">Message me here</h3>
              <div className="space-y-2">
                <div className="flex items-center gap-1">
                  <svg className="w-8 h-8 text-dev-gray" viewBox="0 0 32 32" fill="currentColor">
                  ...
                  <span className="text-dev-gray font-fira-code text-base">!Elias#3519</span>
                </div>
                <div className="flex items-center gap-1">
                  <svg className="w-8 h-8 text-dev-gray" viewBox="0 0 32 32" fill="currentColor">
                  ...
                  <span className="text-dev-gray font-fira-code text-base">elias@elias.me</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="border-t border-dev-gray pt-8 pb-8">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  <Logo />
                  <span className="text-dev-white font-fira-code text-base font-medium">Elias</span>
                </div>
                <span className="text-dev-gray font-fira-code text-base">elias@elias-dev.ml</span>
              </div>
              <p className="text-dev-white font-fira-code text-base">Web designer and front-end developer</p>
            </div>
            
            <div className="flex flex-col gap-3">
              <h3 className="text-dev-white font-fira-code text-2xl font-medium">Media</h3>
              <div className="flex gap-2">
                <svg className="w-8 h-8 text-dev-gray hover:text-dev-white transition-colors cursor-pointer" viewBox="0 0 32 32" fill="currentColor">
                  <path d="M15.5 6C9.69875 6 5 10.5882 5 16.2529C5 20.7899 8.00562 24.6219 12.1794 25.9804C12.7044 26.0701 12.9012 25.7625 12.9012 25.4934C12.9012 25.2499 12.8881 24.4425 12.8881 23.5838C10.25 24.058 9.5675 22.9558 9.3575 22.3791C9.23938 22.0843 8.7275 21.1743 8.28125 20.9308C7.91375 20.7386 7.38875 20.2644 8.26813 20.2516C9.095 20.2388 9.68563 20.9949 9.8825 21.3025C10.8275 22.8533 12.3369 22.4175 12.9406 22.1484C13.0325 21.4819 13.3081 21.0334 13.61 20.777C11.2737 20.5207 8.8325 19.6364 8.8325 15.7147C8.8325 14.5997 9.23938 13.6769 9.90875 12.9592C9.80375 12.7029 9.43625 11.6519 10.0138 10.2422C10.0138 10.2422 10.8931 9.97301 12.9012 11.2931C13.7413 11.0624 14.6338 10.947 15.5263 10.947C16.4188 10.947 17.3113 11.0624 18.1513 11.2931C20.1594 9.9602 21.0387 10.2422 21.0387 10.2422C21.6163 11.6519 21.2488 12.7029 21.1438 12.9592C21.8131 13.6769 22.22 14.5868 22.22 15.7147C22.22 19.6492 19.7656 20.5207 17.4294 20.777C17.81 21.0975 18.1381 21.7126 18.1381 22.6738C18.1381 24.0452 18.125 25.1474 18.125 25.4934C18.125 25.7625 18.3219 26.0829 18.8469 25.9804C20.9314 25.2935 22.7428 23.9854 24.026 22.2403C25.3092 20.4953 25.9996 18.4012 26 16.2529C26 10.5882 21.3013 6 15.5 6Z"/>
                </svg>
          ...
          <div className="text-center mt-12">
            <p className="text-dev-gray font-fira-code text-base">© Copyright 2022. Made by Elias</p>
          </div>
        </footer>
      </div>
    </div>
